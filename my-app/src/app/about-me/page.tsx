                ...
                <HoverCardContent className='w-80 z-50'>
                  <div className='flex justify-between space-x-4'>
                    ...
                    <div className='space-y-1'>
                      ...
                      <p className='text-sm'>
                        The largest university of applied sciences in Flanders.
                        A community of almost 22,000 students, employees and
                        researchers.
                      </p>
          ...
          <div className='w-full'>
            <Card>
              ...
              <CardContent>
                ...
                <p className='leading-7 [&:not(:first-child)]:mt-6'>
                  In case you want to know more about me, you can check out me
                  CV below.
                </p>
